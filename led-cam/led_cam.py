...
#fill in this list with blacklisted faces
not_allowed = []
...
#Blacklisting Function sorts through images ad adds them to a processed list
def blacklisting():
...
#if blacklisting yields 1 (match), alternating lights shine         
def main():
    while (blacklisting() != 1):
        pixels.fill((255, 0, 0))
        time.sleep(1)
        pixels.fill(0, 0, 255)
        time.sleep(1)
